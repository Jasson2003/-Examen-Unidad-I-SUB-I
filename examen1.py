...
ventana.config(bg="#F5B041")
text1 = Text(ventana, bg="#FCFCFC")
tabla = ttk.Treeview(ventana)

boton1 = Button(ventana, text='Ejecutar', command=run, bg="green")
boton2 = Button(ventana, text='Limpiar', command=limpiar, bg="red")

text1.place(x=50, y=80, height=150, width=900)
tabla['columns'] = ('token', 'lexema', 'linea')

# Centro horizontalmente los botones
boton1.place(relx=0.5, y=10, anchor="n")
boton2.place(relx=0.5, y=360, anchor="n")
